<template>
    ...
    <div style=" max-width:600px; margin:auto">
        <div style="margin-top: 20px">
            <card :icon="Setting" title="隐私设置" desc="在这里可以设置哪些内容可以被其他人看到，请各位小伙伴注意自己的隐私" v-loading="saving">
            ...
            <card style="margin: 20px 0" :icon ="Setting" title="修改密码" desc="修改密码请在这里进行操作，请务必牢记您的密码">
              <el-form :rules=rules label-width="100"  :model="form" ref="formRef" @validate="onValidate" style="margin: 20px">
                <el-form-item label="当前密码" prop="password">
                  <el-input :prefix-icon="Lock" type="password" placeholder="当前密码" v-model="form.password" maxlength="16"/>
                </el-form-item>
                <el-form-item label="新密码" prop="new_password">
                  <el-input :prefix-icon="Lock" type="password" placeholder="新密码" v-model="form.new_password"  maxlength="16"/>
                </el-form-item>
                <el-form-item label="重复新密码" prop="new_repeat_password">
                  <el-input :prefix-icon="Lock" type="password" placeholder="重复新密码" v-model="form.new_repeat_password"  maxlength="16"/>
                </el-form-item>
                <div style="text-align: center" @click="resetPassword">
                  <el-button type="success">立即重置密码</el-button>
                </div>
              </el-form>
            </card>
        </div>
